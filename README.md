...
```text
# 2. 把输出的职位列表复制下来
 1. ✅ 仓库管理员/仓管员  7-8K  中建海龙  龙岗区 坪地  06/04 19:13
 2. ✅ 仓管员/仓库管理员  5-7K  开味缘   南山区 蛇口  06/03 18:00
...
```
...
```
 1. ✅ 仓库管理员/仓管员         7-8K     中建海龙           龙岗区 坪地    06/04 19:13
 2. ✅ 仓管员/仓库管理员         5-7K     开味缘            南山区 蛇口    06/03 18:00
 3. ❌ 仓管员/仓库管理员         5-6K     丰年康科技         龙岗区 康桥    05/08 17:55
```
...
### 想一次性搜多个岗位（仓管员+仓库管理员）
目前每次只能填一个关键词。你可以在 boss-search.js 的 `searchUrl` 中用 `|` 分隔：`query=仓管员|仓库管理员`
